...
from .serializers import FileSerializer, FileSerializerTour, FileSerializerWork
...
class FileViewTour(APIView):
  parser_classes = (MultiPartParser, FormParser)
  def postTour(self, request, *args, **kwargs):
...
class FileViewWork(APIView):
  parser_classes = (MultiPartParser, FormParser)
  def postWork(self, request, *args, **kwargs):
